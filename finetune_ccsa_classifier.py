...
parser = argparse.ArgumentParser(description='FaceForensics++ CCSA FineTuning')
...
tgt_path_classifier = MODEL_PATH + 'ccsa_finetune/2classes_' + str(ft_images_train) + 'images/' + transfer_dir +'/' + args.run + '_run/'
